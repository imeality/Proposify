...
@Component({
  selector: 'app-propform4',
  templateUrl: './propform4.component.html',
  styleUrls: ['./propform4.component.css']
})
export class Propform4Component implements OnInit {
  ...
  onClick(Company_name,Company_email,Company_address,Company_country,Company_state ,Company_city,Date) {
    ...
    this.router.navigate(['/proposal2'])
